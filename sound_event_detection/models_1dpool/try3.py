...
class Try3_4conv(nn.Module):
    def __init__(self, num_freq, class_num):
        super(Try3_4conv, self).__init__()
        ##############################
        # YOUR IMPLEMENTATION
        # Args:
        ...
        ##############################
        self.block1 = ConvBlock(in_channels=1, out_channels=16, kernel_size=5)
        self.block2 = ConvBlock(in_channels=16, out_channels=32, kernel_size=5)
